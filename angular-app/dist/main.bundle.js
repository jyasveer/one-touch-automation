...
var CreateVmComponent = (function () {
    ...
    CreateVmComponent.prototype.checkIfVcNameExists = function () {
        if (this.newVcName) {
            this.isVcNamePresent = false;
            if (this.regionData['vcenters'].indexOf(this.newVcName) !== -1) {
...
var DeleteVmComponent = (function () {
    function DeleteVmComponent(service) {
        this.service = service;
        this.machineName = '';
        this.vcName = '';
        this.email = '';
